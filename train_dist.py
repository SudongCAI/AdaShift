...
from optim_factory_convnext_gf import create_optimizer, LayerDecayValueAssigner
...
# register models
import MODELS.resnet_adashiftb_timm
import MODELS.resnet_adashiftma_timm
import MODELS.resnet_adashiftma_n1_n2_n3
...
def main():
    ...
    try:
        for epoch in range(start_epoch, num_epochs):
            ...
            # model_preserve
            #torch.save(model.module.state_dict(), '/home/scai/workspace/Imagenet_space/output/train/dnl_res101_cos120/' + 'dnl_resnet50_' + np.str(epoch) + '.pth')

...
default_cfg = {
    'silumod_resnet14': _cfg(
        url='',
        interpolation='bicubic'),
    'silumod_resnet26': _cfg(
        url='',
        interpolation='bicubic'),
    'silumod_resnet50': _cfg(
        url='',
        interpolation='bicubic'),
    'silumod_resnet101': _cfg(
        url='',
        interpolation='bicubic'),
    'silumod_resnet152': _cfg(
        url='',
        interpolation='bicubic')
}
...
class silumod(nn.Module):
    ...
    def forward(self, x):
        ...
        shift = self.norm(self.stats(x).squeeze()).unsqueeze(-1).unsqueeze(-1) # b c 1 1
...
@register_model
def silumod_resnet14(pretrained=False, **kwargs):
    """
    """
    model_args = dict(block=Bottleneck, layers=[1, 1, 1, 1],  **kwargs)
    return build_model_with_cfg(
        ResNet, 'silumod_resnet14', default_cfg=default_cfg['silumod_resnet14'],
        pretrained=pretrained, **model_args)



@register_model
def silumod_resnet26(pretrained=False, **kwargs):
    """
    """
    model_args = dict(block=Bottleneck, layers=[2, 2, 2, 2],  **kwargs)
    return build_model_with_cfg(
        ResNet, 'silumod_resnet26', default_cfg=default_cfg['silumod_resnet26'],
        pretrained=pretrained, **model_args)



@register_model
def silumod_resnet50(pretrained=False, **kwargs):
    """
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3],  **kwargs)
    return build_model_with_cfg(
        ResNet, 'silumod_resnet50', default_cfg=default_cfg['silumod_resnet50'],
        pretrained=pretrained, **model_args)



@register_model
def silumod_resnet101(pretrained=False, **kwargs):
    """
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 23, 3],  **kwargs)
    return build_model_with_cfg(
        ResNet, 'silumod_resnet101', default_cfg=default_cfg['silumod_resnet101'],
        pretrained=pretrained, **model_args)
